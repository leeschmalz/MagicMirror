...
!(function (a, b) {
				...
				for ("boolean" == typeof g && ((j = g), (g = arguments[h] || {}), h++), "object" == typeof g || o.isFunction(g) || (g = {}), h === i && ((g = this), h--); i > h; h++)
					if (null != (a = arguments[h]))
						for (b in a)
							(c = g[b]),
								(d = a[b]),
								g !== d && (j && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? ((e = !1), (f = c && o.isArray(c) ? c : [])) : (f = c && o.isPlainObject(c) ? c : {}), (g[b] = o.extend(j, f, d))) : void 0 !== d && (g[b] = d));
				return g;
			}),
		o.extend({
	...
	function tb(a) {
		var b = m,
			c = rb[a];
		return (
			c || ((c = sb(a, b)), ("none" !== c && c) || ((qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)), (b = qb[0].contentDocument), b.write(), b.close(), (c = sb(a, b)), qb.detach()), (rb[a] = c)), c
		);
	}
	var ub = /^margin/,
	...
	(o.offset = {
		...
		o.fn.extend({
			offset: function (a) {
				...
				if (f)
					return (
						(b = f.documentElement), o.contains(b, d) ? (typeof d.getBoundingClientRect !== U && (e = d.getBoundingClientRect()), (c = Kc(f)), { top: e.top + c.pageYOffset - b.clientTop, left: e.left + c.pageXOffset - b.clientLeft }) : e
					);
			},
			position: function () {
				if (this[0]) {
