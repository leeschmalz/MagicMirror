	...
	(function (a, b) {
						...
						if (i[y](z) && (ca[y](z) || d.paper.customAttributes[y](z)))
							switch (((r[z] = d.attr(z)), null == r[z] && (r[z] = ba[z]), (s[z] = i[z]), ca[z])) {
								...
								case "transform":
									var G = d._,
										J = Na(G[z], s[z]);
									if (J) for (r[z] = J.from, s[z] = J.to, t[z] = [], t[z].real = !0, w = 0, x = r[z].length; x > w; w++) for (t[z][w] = [r[z][w][0]], E = 1, F = r[z][w].length; F > E; E++) t[z][w][E] = (s[z][w][E] - r[z][w][E]) / q;
									else {
		...
		var t,
			...
			ma = (b._rectPath = function (a, b, c, d, e) {
				return e
					? [["M", a + e, b], ["l", c - 2 * e, 0], ["a", e, e, 0, 0, 1, e, e], ["l", 0, d - 2 * e], ["a", e, e, 0, 0, 1, -e, e], ["l", 2 * e - c, 0], ["a", e, e, 0, 0, 1, -e, -e], ["l", 0, 2 * e - d], ["a", e, e, 0, 0, 1, e, -e], ["z"]]
			...
			pa = (b.mapPath = function (a, b) {
				if (!b) return a;
				var c, d, e, f, g, h, i;
				for (a = Ia(a), e = 0, g = a.length; g > e; e++) for (i = a[e], f = 1, h = i.length; h > f; f += 2) (c = b.x(i[f], i[f + 1])), (d = b.y(i[f], i[f + 1])), (i[f] = c), (i[f + 1] = d);
				return a;
			});
			...
			(b.is = function (a, b) {
				return (
					...
					"finite" == b
						...
						: "array" == b
						? a instanceof Array
						: ("null" == b && null === a) || (b == typeof a && null !== a) || ("object" == b && a === Object(a)) || ("array" == b && Array.isArray && Array.isArray(a)) || V.call(a).slice(8, -1).toLowerCase() == b
				);
			}),
		...
		(b.color = function (a) {
			...
			return (
				b.is(a, "object") && "h" in a && "s" in a && "b" in a
					...
					: (b.is(a, "string") && (a = b.getRGB(a)),
					  b.is(a, "object") && "r" in a && "g" in a && "b" in a ? ((c = b.rgb2hsl(a)), (a.h = c.h), (a.s = c.s), (a.l = c.l), (c = b.rgb2hsb(a)), (a.v = c.b)) : ((a = { hex: "none" }), (a.r = a.g = a.b = a.h = a.s = a.v = a.l = -1))),
				(a.toString = va),
				a
			);
		}),
			...
			(b.rgb2hsb = function (a, b, c) {
				...
				var d, e, f, g;
				return (f = N(a, b, c)), (g = f - O(a, b, c)), (d = 0 == g ? null : f == a ? (b - c) / g : f == b ? (c - a) / g + 2 : (a - b) / g + 4), (d = (((d + 360) % 6) * 60) / 360), (e = 0 == g ? 0 : g / f), { h: d, s: e, b: f, toString: ta };
			}),
				...
				? (j[2] && ((e = _(j[2].substring(5), 16)), (d = _(j[2].substring(3, 5), 16)), (c = _(j[2].substring(1, 3), 16))),
				  ...
				  j[5]
						...
						? ((i = j[6][I](da)),
						  ...
						  i[3] && "%" == i[3].slice(-1) && (g /= 100),
						  b.hsl2rgb(c, d, e, g))
						: ((j = { r: c, g: d, b: e, toString: f }), (j.hex = "#" + (16777216 | e | (d << 8) | (c << 16)).toString(16).slice(1)), b.is(g, "finite") && (j.opacity = g), j))
						...
						for (var l = 0, m = d.length; m > l; l++) {
							...
							"t" == v && 3 == u
								...
								? 2 == u || 3 == u
									...
									: 5 == u && (w ? ((q = x.x(t[3], t[4])), (r = x.y(t[3], t[4])), k.scale(t[1], t[2], q, r)) : k.scale(t[1], t[2], t[3], t[4]), (h *= t[1]), (i *= t[2]))
					...
					(a.toTransformString = function (a) {
						...
						return b.isSimple
							? ((b.scalex = +b.scalex.toFixed(4)),
							  ...
							  (b.dx || b.dy ? "t" + [b.dx, b.dy] : F) + (1 != b.scalex || 1 != b.scaley ? "s" + [b.scalex, b.scaley, 0, 0] : F) + (b.rotate ? "r" + [b.rotate, 0, 0] : F))
		...
		for (
			...
			!(function (a) {
				(b[a] = Xa[a] =
					function (c, d) {
						return b.is(c, "function") && ((this.events = this.events || []), this.events.push({ name: a, f: c, unbind: Ta(this.shape || this.node || z.doc, a, c, d || this) })), this;
					}),
					(b["un" + a] = Xa["un" + a] =
						function (c) {
		...
		(u.getElementByPoint = function (a, b) {
			...
			(Xa.getBBox = function (a) {
				...
				return a
					...
					: ((b.dirty || b.dirtyT || !b.bbox) && ((b.dirty || !this.realPath) && ((b.bboxwt = 0), (this.realPath = oa[this.type](this))), (b.bbox = za(pa(this.realPath, this.matrix))), (b.bbox.toString = o), (b.dirty = b.dirtyT = 0)),
					  b.bbox);
			}),
			(Xa.clone = function () {
			...
			(Xa.glow = function (a) {
				...
				a = a || {};
				var b = { width: (a.width || 10) + (+this.attr("stroke-width") || 1), fill: a.fill || !1, opacity: null == a.opacity ? 0.5 : a.opacity, offsetx: a.offsetx || 0, offsety: a.offsety || 0, color: a.color || "#000" },
					c = b.width / 2,
					d = this.paper,
					e = d.set(),
		...
		var _a = function (a, c, d, e, f, g, h, k, l) {
			...
			ab = function (a, c) {
				return function (d, e, f) {
					...
					return (m.end = l), (k = a ? n : c ? m : b.findDotsAtSegment(g, h, i[0], i[1], i[2], i[3], i[4], i[5], 1)), k.alpha && (k = { x: k.x, y: k.y, alpha: k.alpha }), k;
				};
			},
			bb = ab(1),
			cb = ab(),
			...
			hb = function () {
				for (var c = +new Date(), d = 0; d < fb.length; d++) {
					...
					if (!e.el.removed && !e.paused) {
						...
						if (
							(e.initstatus
								? ((h = ((e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev)) * i), (e.status = e.initstatus), delete e.initstatus, e.stop && fb.splice(d--, 1))
									...
									if (k[y](s)) {
										switch (ca[s]) {
											...
											case "path":
												...
												break;
											case "transform":
												if (l[s].real) for (f = [], t = 0, u = k[s].length; u > t; t++) for (f[t] = [k[s][t][0]], v = 1, w = k[s][t].length; w > v; v++) f[t][v] = k[s][t][v] + q * i * l[s][t][v];
												else {
													var x = function (a) {
		...
		(Xa.animateWith = function (a, c, d, e, f, g) {
			...
			(Xa.pause = function (b) {
				for (var c = 0; c < fb.length; c++) fb[c].el.id != this.id || (b && fb[c].anim != b) || (a("raphael.anim.pause." + this.id, this, fb[c].anim) !== !1 && (fb[c].paused = !0));
				return this;
			}),
			...
			(Xa.stop = function (b) {
				for (var c = 0; c < fb.length; c++) fb[c].el.id != this.id || (b && fb[c].anim != b) || (a("raphael.anim.stop." + this.id, this, fb[c].anim) !== !1 && fb.splice(c--, 1));
				return this;
			}),
		...
		var jb = function (a) {
			...
			kb = jb.prototype;
		(kb.push = function () {
			for (var a, b, c = 0, d = arguments.length; d > c; c++) (a = arguments[c]), !a || (a.constructor != Xa.constructor && a.constructor != jb) || ((b = this.items.length), (this[b] = this.items[b] = a), this.length++);
			return this;
		}),
			(kb.pop = function () {
		...
		if (!a || a.svg) {
			...
			var q = function (d, e) {
				...
				r = function (b, e) {
					...
					if (!s) {
						...
						if (((k = k.replace(/[\(\)\s,\xb0#]/g, "_")), b.gradient && k != b.gradient.id && (p.defs.removeChild(b.gradient), delete b.gradient), !b.gradient)) {
							(s = q(j + "Gradient", { id: k })), (b.gradient = s), q(s, "radial" == j ? { fx: m, fy: n } : { x1: u[0], y1: u[1], x2: u[2], y2: u[3], gradientTransform: b.matrix.invert() }), p.defs.appendChild(s);
							for (var x = 0, y = w.length; y > x; x++) s.appendChild(q("stop", { offset: w[x].offset ? w[x].offset : x ? "100%" : "0%", "stop-color": w[x].color || "#fff", "stop-opacity": isFinite(w[x].opacity) ? w[x].opacity : 1 }));
						}
					}
					return q(o, { fill: "url('" + document.location.origin + document.location.pathname + "#" + k + "')", opacity: 1, "fill-opacity": 1 }), (r.fill = l), (r.opacity = 1), (r.fillOpacity = 1), 1;
				},
				s = function (a) {
					var b = a.getBBox(1);
				...
				t = function (d, e, f) {
					if ("path" == d.type) {
						...
						if (
							("open" == w ? ((x += 2), (y += 2), (z += 2), (i = 1), (j = f ? 4 : 1), (k = { fill: "none", stroke: t.stroke })) : ((j = i = x / 2), (k = { fill: t.stroke, stroke: "none" })),
							d._.arrows
								? f
							...
							D
								...
								: ((D = q(q("marker"), { id: B, markerHeight: y, markerWidth: x, orient: "auto", refX: j, refY: y / 2 })),
								  (C = q(q("use"), { "xlink:href": "#" + A, transform: (f ? "rotate(180 " + x / 2 + " " + y / 2 + ") " : l) + "scale(" + x / z + "," + y / z + ")", "stroke-width": (1 / ((x / z + y / z) / 2)).toFixed(4) })),
								  D.appendChild(C),
								  n.defs.appendChild(D),
								  (p[B] = 1)),
								q(C, k);
							var E = i * ("diamond" != w && "oval" != w);
							f ? ((g = d._.arrows.startdx * u || 0), (h = a.getTotalLength(t.path) - E * u)) : ((g = E * u), (h = a.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
								(k = {}),
								(k["marker-" + r] = "url(#" + B + ")"),
				...
				v = function (a, b, d) {
					if ((b = u[c(b).toLowerCase()])) {
						for (var e = a.attrs["stroke-width"] || "1", f = { round: e, square: e, butt: 0 }[a.attrs["stroke-linecap"] || d["stroke-linecap"]] || 0, g = [], h = b.length; h--; ) g[h] = b[h] * e + (h % 2 ? 1 : -1) * f;
					...
					for (var o in f)
						if (f[b](o)) {
							...
							switch (((k[o] = p), o)) {
								...
								case "fill-opacity":
									if (k.gradient) {
										(I = a._g.doc.getElementById(i.getAttribute("fill").replace(/^url\(#|\)$/g, l))), I && ((J = I.getElementsByTagName("stop")), q(J[J.length - 1], { "stop-opacity": p }));
										break;
									}
								default:
				...
				y = function (d, f) {
					if ("text" == d.type && (f[b]("text") || f[b]("font") || f[b]("font-size") || f[b]("x") || f[b]("y"))) {
						...
						if (f[b]("text")) {
							...
							for (var j, k = c(f.text).split("\n"), m = [], n = 0, o = k.length; o > n; n++) (j = q("tspan")), n && q(j, { dy: i * x, x: g.x }), j.appendChild(a._g.doc.createTextNode(k[n])), h.appendChild(j), (m[n] = j);
			...
			(A.prototype = B),
				...
				(a._engine.text = function (b, c, d, e) {
					...
					var g = new A(f, b);
					return (g.attrs = { x: c, y: d, "text-anchor": "middle", text: e, "font-family": a._availableAttrs["font-family"], "font-size": a._availableAttrs["font-size"], stroke: "none", fill: "#000" }), (g.type = "text"), w(g, g.attrs), g;
				}),
				...
				(a._engine.setViewBox = function (a, b, c, d, e) {
					...
					for (
						null == a ? (this._vbSize && (j = 1), delete this._vbSize, (f = "0 0 " + this.width + m + this.height)) : ((this._vbSize = j), (f = a + m + b + m + c + m + d)), q(this.canvas, { viewBox: f, preserveAspectRatio: n });
						j && l;
		...
		if (!a || a.vml) {
				...
				B = function (e, i) {
					...
					if (
						...
						((i.path && "path" == e.type) || q) &&
							((l.path = x(~c(m.path).toLowerCase().indexOf("r") ? a._pathToAbsolute(m.path) : m.path)), (e._.dirty = 1), "image" == e.type && ((e._.fillpos = [m.x, m.y]), (e._.fillsize = [m.width, m.height]), z(e, 1, 1, 0, 0, 0))),
						...
						if (((K = K && K[0]), !K && (L = K = F(j)), "image" == e.type && i.src && (K.src = i.src), i.fill && (K.on = !0), (null == K.on || "none" == i.fill || null === i.fill) && (K.on = !1), K.on && i.fill)) {
							...
							if (M) {
								...
								(K.color = a.getRGB(i.fill).hex),
									(K.src = o),
									(K.type = "solid"),
									a.getRGB(i.fill).error && (s.type in { circle: 1, ellipse: 1 } || "r" != c(i.fill).charAt()) && C(s, i.fill, K) && ((m.fill = "none"), (m.gradient = i.fill), (K.rotate = !1));
						}
				...
				C = function (b, f, g) {
					...
					if (
						...
						(f = c(f).replace(a._radial_gradient, function (a, b, c) {
							return (i = "radial"), b && c && ((b = d(b)), (c = d(c)), h(b - 0.5, 2) + h(c - 0.5, 2) > 0.25 && (c = e.sqrt(0.25 - h(b - 0.5, 2)) * (2 * (c > 0.5) - 1) + 0.5), (j = b + n + c)), o;
						})),
						(f = f.split(/\s*\-\s*/)),
						"linear" == i)
					) {
			...
			(D.prototype = E),
				...
				(E.translate = function (a, b) {
					return this.removed
						? this
						: ((a = c(a).split(k)), a.length - 1 && (b = d(a[1])), (a = d(a[0]) || 0), (b = +b || 0), this._.bbox && ((this._.bbox.x += a), (this._.bbox.y += b)), this.transform(this._.transform.concat([["t", a, b]])), this);
				}),
