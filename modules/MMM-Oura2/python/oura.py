...
def getDailyDataV1(dataType, startDate, endDate, token):
	...
	if dataType == 'sleep' or dataType == 'readiness':
		# normalize scores due to bad sleep staging algorithm. remove after ss beta is incorporated
		df['score'] = df['score'] + 15
...
startdate = today - relativedelta(months=months, days=days)
