	...
	socketNotificationReceived: function (notification, payload) {
		if (notification === "OPENWEATHER_ONE_CALL_FORECAST_GET") {
			...
			if (payload.apikey == null || payload.apikey == "") {
				...
				var url =
					"https://api.openweathermap.org/data/2.5/onecall" + "?appid=" + payload.apikey + "&lat=" + payload.latitude + "&lon=" + payload.longitude + (payload.units !== "" ? "&units=" + payload.units : "") + "&lang=" + payload.language;
				// "&exclude=minutely"
